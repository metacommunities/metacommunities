...
big = subset(data, data$PullRequestEvents > 99)
...
hist(data$IntraRepoProp, col = "blue", xlab = "Proportion of Pull Requests opened which are Intra Repo", main = "Intra Repo Pull Requests", breaks = 99)

pr1 = subset(data, data$PullRequestEvents == 1)
